---
title: Lark CLI Service - 一个类 CRA 工具
---
...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle">一个命令开启一个现代Web应用程序 <br className='sm:block hidden'/>更快、更简单且业务友好</p>
    <p className="subtitle">
      <Link className={styles.cta} href="/docs"> 开始 <span>→</span></Link>
    </p>
  </div>
  <style jsx>{`
    .content-container {
      ...
      <Features>
        ...
        <Feature index={1} centered className="card-with-border" href="/docs/guide/image">
          <div className="h-full flex flex-col justify-between">
            <h3>Console、Mobile、PC等 <br className="show-on-mobile"/>模版 <span style={{ fontWeight: 300 }}>都已支持</span></h3>
