---
title: Lark CLI Service - A CRA CONFIGURATION OVERRIDE
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">CREATE REACT APP <br className='sm:block hidden'/>CONFIGURATION OVERRIDE </h1>
    <p className="subtitle">Set up a modern web app by running one command. <br className='sm:block hidden'/>Faster, simpler and more business-oriented</p>
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs/welcome">
          <Image src={docsCard} alt="Background" loading="eager" />
          <Image src={docsCardDark} alt="Background (Dark)" loading="eager" />
          <h3>Support multiple templates <br className="show-on-mobile"/>in minutes.</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="/docs/guide/image">
          <div className="h-full flex flex-col justify-between">
            <h3>Console、Mobile、PC <br className="show-on-mobile"/>always <span style={{ fontWeight: 300 }}>support</span>.</h3>
